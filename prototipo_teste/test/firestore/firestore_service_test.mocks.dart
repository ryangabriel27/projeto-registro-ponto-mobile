...
// in prototipo_teste/test/firestore/firestore_service_test.dart.
...
class MockFuncionariosCollection extends _i1.Mock
    implements _i4.CollectionReference<Map<String, dynamic>> {
  MockFuncionariosCollection() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockFuncionariosQuerySnapshot extends _i1.Mock
    implements _i4.QuerySnapshot<Map<String, dynamic>> {
  MockFuncionariosQuerySnapshot() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockFuncionariosDocumentSnapshot extends _i1.Mock
    implements _i4.QueryDocumentSnapshot<Map<String, dynamic>> {
  MockFuncionariosDocumentSnapshot() {
    _i1.throwOnMissingStub(this);
  }
